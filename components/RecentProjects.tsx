...
import { PinContainer } from "./ui/3d-card";
  ...
  return (
    <div className="py-20" id="projects">
      <h1 className="heading">
        ...
        <span className="text-purple dark:text-purple-dark">recent projects</span>
      </h1>
            ...
            >
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                ...
                <div className="flex justify-center items-center">
                  <p className="flex lg:text-l md:text-xs text-sm text-purple dark:text-purple-dark">
                    Check Live Site
                  </p>
