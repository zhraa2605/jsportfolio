...
const Hero = () => {
  return (
    <div className="pb-20 pt-24">
      ...
      <div className="h-screen w-full bg-white dark:bg-black-100 dark:bg-grid-white/[0.02] bg-grid-black/[0.1] flex items-center justify-center absolute top-0 left-0">
      ...
      <div className="flex justify-center my-20 relative z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h1 className="uppercase tracking-widest text-center text-primary dark:text-primary-dark max-w-80 text-xs">
          ...
          <p className="text-center mb-4 text-sm md:text-lg lg:text-2xl">
            Hi, I&apos;m Zahraa, A Next.js Developer 
          </p>
          <a href="#about">
            <MagicButton 
              title="Show My Work"
